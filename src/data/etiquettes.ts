...
export const STORIES: Story[] = [
  ...
  {
    categoryId: 'eating',
    title: 'أَرْنُوبُ وَدُعَاءُ الأَكْلِ 🐰🍎',
    badgeName: 'وِسَامُ الذَّاكِرِ الشَّاكِرِ',
    badgeIcon: '🐰🍎',
    slides: [
      {
        text: 'يَجْلِسُ الأَرْنَبُ سِمْسِمٌ السَّعِيدُ أَمَامَ طَبَقِ الجَزَرِ الشَّهِيِّ، وَهُوَ جَائِعٌ جِدًّا وَيُرِيدُ أَنْ يَبْدَأَ بِالأَكْلِ!',
        illustration: 'hungry_bunny',
        highlightWord: 'جَائِعٌ'
      },
      {
        text: 'قَبْلَ أَنْ يَضَعَ سِمْسِمٌ لُقْمَتَهُ الأُولَى، تَذَكَّرَ وَقَالَ بِأَدَبٍ: (بِسْمِ اللهِ الرَّحْمَنِ الرَّحِيمِ) لِتَحِلَّ البَرَكَةُ فِي طَعَامِهِ.',
        illustration: 'bunny_saying_bismillah',
        highlightWord: 'بِسْمِ اللهِ'
      },
      {
        text: 'إِذَا نَسِيَ سِمْسِمٌ البَسْمَلَةَ فِي البِدَايَةِ، فَقَدْ عَلَّمَنَا رَسُولُنَا ﷺ أَنْ نَقُولَ عِنْدَ تَذَكُّرِنَا: (بِسْمِ اللهِ فِي أَوَّلِهِ وَآخِرِهِ).',
        illustration: 'bunny_remembering',
        highlightWord: 'أَوَّلِهِ وَآخِرِهِ'
      },
      {
        text: 'بَعْدَ أَنْ شَبِعَ سِمْسِمٌ وَأَكَلَ الجَزَرَ اللَّذِيذَ، مَسَحَ فَمَهُ وَقَالَ بِحَمْدٍ وَفَرَحٍ: (الحَمْدُ للهِ الَّذِي أَطْعَمَنَا وَسَقَانَا وَجَعَلَنَا مُسْلِمِينَ).',
        illustration: 'bunny_thanking_allah',
        highlightWord: 'الحَمْدُ للهِ'
      }
    ]
  },
